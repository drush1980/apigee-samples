...
proxy_name="llm-security-v2-anthropic-vertex"
...
product_name="llm-security-product-v2-anthropic-vertex"
dev_moniker="llm-security-developer-v2-anthropic-vertex"
app_name="llm-security-app-v2-anthropic-vertex"
...
PROXY_URL="$APIGEE_HOST/v1/vertex-anthropic"
